...
export const getReqBody = (request, listOfProps) => {
...
export const trimmer = (reqBody, request) => {
...
*/
export const emptyFieldsFinder = (reqBody) => {
...
*/
export const nonStringFieldFinder = (reqBody) => {
  const arrayOfFields = Object.keys(reqBody);
...
export const specialValidation = {
...
*/
export const message = (statusCode, response, invalidFieldsArray, end, failReason) => {
  const verb = invalidFieldsArray.length === 1 ? ['field', 'was'] : ['fields', 'were'];
  return messageResponse(response, statusCode, {
...
* @returns {Array.<string>} - an array of the invalid integer fields as strings
*/
export const invalidFieldsChecker = reqBody => Object.keys(reqBody).filter((elm) => {
...
export const nonStringFieldHandler = (reqBody, response, failReason) => {
...
export const invalidFieldMessage = (invalidFieldsArr, response, failReason) => {
...
export const invalidFieldHandler = (reqBody, response, failReason) => {
  const invalidFieldsArr = invalidFieldsChecker(reqBody);
  return invalidFieldMessage(invalidFieldsArr, response, failReason);
};
export const emptyFieldsHandler = (reqBody, response, failReason) => {
...
*/
export const createARequestValidator = (request, response, next) => {
